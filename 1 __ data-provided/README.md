...
[REST Countries API](https://restcountries.com) to pull country data and display
...
**⚠️ NOTE ⚠️: Sometimes the REST Countries API can go down. We've added a
`data.json` file with all the country data if you prefer to use that instead.
However, please be aware that the data in the JSON file might not be
up-to-date.**
...
the [REST Countries API](https://restcountries.com) and you can use an icon font
